...
# Extend Gemini Enterprise assistant capabilities: Challenge Lab


[![Watch on YouTube](https://img.shields.io/badge/Watch_on_YouTube-FF0000?style=for-the-badge&logo=youtube&logoColor=white)](https://youtu.be/K7bXwpuK2q0)
...
{
  "store_number": "123",
  "feedback": "I found that everything in the bakery area was in need of a cleaning."
}
```
### Json Output 
```
...
### Prompt
```
Ask the user for the store number and their feedback. After collecting both, call the Record Employee Feedback tool using this JSON format:
{ "store_number": "<number>", "feedback": "<text>" }
Then reply: ‘Thank you, your feedback is recorded.
```

### Instructions
```
Ask the user for the store number and their feedback. When both are provided, call the Record Employee Feedback tool using { "store_number": "...", "feedback": "..." }. After the tool call, tell the user: ‘Thank you, your feedback is recorded.’
