...
echo "${CYAN_TEXT}${BOLD_TEXT}        WELCOME TO DR. ABHISHEK'S GCP CLOUD ARMOR LAB       ${RESET_FORMAT}"
echo "${CYAN_TEXT}${BOLD_TEXT}==================================================================${RESET_FORMAT}"
echo
...
echo "${GREEN_TEXT}${BOLD_TEXT}For more cloud security and networking tutorials${RESET_FORMAT}"
