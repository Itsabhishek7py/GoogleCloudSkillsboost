...
echo "${BG_BLUE}${WHITE}${BOLD}        🚀 Welcome to Dr Abhishek Tutorial 🚀        ${RESET}"
...
echo "${BG_RED}${WHITE}${BOLD}  🔔 Subscribe to Dr Abhishek Tutorial on YouTube 🔔 ${RESET}"
echo "${BG_RED}${WHITE}${BOLD}  https://www.youtube.com/@drabhishek.5460/videos     ${RESET}"
echo "${BG_RED}${WHITE}${BOLD}=====================================================${RESET}"
echo ""
